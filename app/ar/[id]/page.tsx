  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-[#001a18] to-black flex flex-col items-center justify-start pt-0 font-sans">
      ...
      <div className="w-full flex-1 relative" style={{ minHeight: '70vh' }}>
        ...
        >
          ...
          <button slot="ar-button" style={{
            background: '#00665E', color: 'white', border: 'none',
            padding: '12px 24px', borderRadius: '50px', fontWeight: '900',
            fontSize: '14px', position: 'absolute', bottom: '24px', right: '24px',
            cursor: 'pointer', boxShadow: '0 10px 30px rgba(0,102,94,0.4)',
          ...
          <div slot="poster" style={{
            ...
            height: '100%', width: '100%', flexDirection: 'column', gap: '16px'
          }}>
      ...
      <div className="w-full max-w-2xl mx-auto px-6 py-8 flex flex-col items-center text-center gap-6">
        ...
        {tour.cta_url && (
          <a href={tour.cta_url} target="_blank" rel="noopener noreferrer"

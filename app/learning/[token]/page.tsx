            ...
            <div className="w-80 bg-white border-r border-gray-200 flex flex-col shadow-sm shrink-0 print:hidden">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-2 custom-scrollbar">
                    ...
                    <div className="pt-6 pb-4">
                        <button onClick={() => setActiveView('certificate')} className={`w-full p-4 rounded-2xl text-sm font-bold border-2 transition flex flex-col items-center justify-center gap-2 text-center ${activeView === 'certificate' ? 'bg-green-50 border-green-500 text-green-700 shadow-md' :
